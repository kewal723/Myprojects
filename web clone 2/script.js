...
document.addEventListener("DOMContentLoaded", function () {
  // Your Locomotive Scroll setup (loco() function) goes here
...
function canvas1(){
  const canvas = document.querySelector("#page-18>canvas");
const context = canvas.getContext("2d");
...
scrollTrigger: {
  trigger: "#page-21",
  start: "top top",
  endTrigger: "#center-text",
  end: "top center", // Set the end point to the top of #center-text
  scrub: 1,
  scroller: "#main",
  onEnter: () => {
    gsap.to("#page-21>#troff", { opacity: 0 });
  },
  onLeaveBack: () => {
    gsap.to("#page-21>#troff", { opacity: 1 });
  },
},
});

// Additional animation for #center-text
...
scrollTrigger: {
  ...
  scroller: "#main",
  onEnter: () => {
    gsap.set("#center-text", { backgroundColor: "black" }); // Set background color directly without animation
  },
  onLeaveBack: () => {
    gsap.set("#center-text", { backgroundColor: "black" }); // Set background color directly without animation
  },
...
scrollTrigger:{
    trigger:`#page-22`,
    start:`top top`,
    endTrigger: "#center-text", // Set the end trigger to #center-text
    end: "bottom bottom", // Set the end point to the bottom of #center-text
    scrub:1,
    scroller:`#main`,
    pin:true,
    pinSpacing: false, // Set pinSpacing to false
}
})


tl5.to("#page-22>#snroff",{
opacity:0
})

...
// Route for experience page to display all experiences
app.get("/experience", async (req, res) => {
    try {
        const experiences = await ExperienceCollection.find();  // Fetch all experiences
        res.render("experience", { experiences });  // Render experience page with experiences
    } catch (err) {
